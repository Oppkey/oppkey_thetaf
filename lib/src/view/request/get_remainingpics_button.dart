...
/// Gets an estimated remaining number of shots for
/// the current shooting settings.
class GetRemainingPicsButton extends StatelessWidget {
  ...
  const GetRemainingPicsButton({
    Key? key,
    this.style,
    this.focusNode,
    this.autofocus = false,
    this.clipBehavior = Clip.none,
    this.label = 'Remaining Pics',
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
        ...
        onPressed: () async {
          ...
          // for each option
          response = 'attempting to get option for remainingPictures\n'
                  '-------------------\n' +
              response;
