...
/// Set shooting setting to normal. Setting at the same time as
/// exposureDelay will result in an error.
class SetFunctionNormalButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
        ...
        onPressed: () async {
          var response = await setOption(name: '_function', value: 'normal');
