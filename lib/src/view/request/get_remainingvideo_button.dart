...
/// Gets the estimated remaining shooting time in seconds
/// for the current video shooting settings.
class GetRemainingVideoButton extends StatelessWidget {
    ...
    return OutlinedButton(
        ...
        onPressed: () async {
          var response = await command('getOptions', parameters: {
            'optionNames': ['remainingVideoSeconds']
          });
          // set title for response. Edit the line below
          // for each option
          response = 'attempting to get option for remainingVideoSeconds\n'
                  '-------------------\n' +
              response;
