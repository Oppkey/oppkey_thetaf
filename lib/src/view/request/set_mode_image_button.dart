...
class SetModeImageButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
        ...
        onPressed: () async {
          var response = await setOption(name: 'captureMode', value: "image");
          // set title for response. Edit the line below
          // for each option
          response = 'attempting to set option for captureMode\n'
                  '-------------------\n' +
              response;
